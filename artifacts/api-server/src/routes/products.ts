...
import { db, productsTable, categoriesTable, subcategoriesTable, branchesTable, brandsTable, publisherSeriesTable, bookClassesTable, bookSubjectsTable } from "@workspace/db";
